    ...
    private void edit_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edit_btnActionPerformed
        // TODO add your handling code here:
         try {
            ...
            dbcon.IDU("UPDATE income SET `date` = '"+date+"' WHERE `id` = '"+id+"' ");
            dbcon.IDU("UPDATE income SET `bill` = '"+bill+"' WHERE `id` = '"+id+"' ");
            dbcon.IDU("UPDATE income SET `customer` = '"+customer+"'WHERE `id` = '"+id+"'");
            dbcon.IDU("UPDATE income SET `income` = '"+income+"'WHERE `id` = '"+id+"'");
